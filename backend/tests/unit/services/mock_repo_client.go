...
func NewClient(readImpl func() error, servicesData []interface{}, errServicesData []interface{}) repos.Client {
	c := &mockRepoClient{
		options:        repos.NewClientOptions(),
		readImpl:       readImpl,
		services:       servicesData,
		errServices:    errServicesData,
		readCalledWith: []map[string]string{},
		mtx:            sync.RWMutex{},
	}
